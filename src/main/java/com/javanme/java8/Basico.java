...
public class Basico {
     ...
     */
    public List<String> ejercicio1(List<String> palabras) throws UnsupportedOperationException {
        Stream<String> myStream = palabras.stream().map(String::toUpperCase);
     ...
     */
    public List<String> ejercicio2(List<String> listado) throws UnsupportedOperationException {
        Stream<String> myStream = listado.stream().filter(x -> x.length() > 10);
        return myStream.collect(Collectors.toList());
    }
     ...
     */
    public String ejercicio3(List<String> listado) throws UnsupportedOperationException {
        Stream<String> myStream = listado.stream().skip(2).limit(3);
        return myStream.collect(joining("-"));
    }
     ...
     * @see java.util.stream.Collectors
     */
    public List<Integer> ejercicio4(List<String> listado) throws UnsupportedOperationException {
        Stream<Integer> myStream = listado.stream().map(x -> Integer.parseInt(x));
     ...
     * @see java.util.stream.Collectors
     */
    public List<String> ejercicio5(List<String> listado) throws UnsupportedOperationException {
        Stream<String> myStream = listado.stream()
